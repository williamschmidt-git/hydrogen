...
export declare namespace StateMachine {
    ...
    type Transition<TContext extends object, TEvent extends EventObject, TStateValue extends string = string> = TStateValue | {
        target?: TStateValue;
    ...
    interface State<TContext extends object, TEvent extends EventObject, TState extends Typestate<TContext>> {
        ...
        matches: <TSV extends TState['value']>(value: TSV) => this is State<(TState extends any ? {
            value: TSV;
            context: any;
        } extends TState ? TState : never : never)['context'], TEvent, TState> & {
            value: TSV;
        };
    }
    ...
    interface Config<TContext extends object, TEvent extends EventObject, TState extends Typestate<TContext> = Typestate<TContext>> {
        id?: string;
