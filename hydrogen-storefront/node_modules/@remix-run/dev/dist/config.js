...
async function readConfig(remixRoot, serverMode = serverModes.ServerMode.Production) {
  var _appConfig$future, _appConfig$future2, _appConfig$future3, _appConfig$future4, _appConfig$future5, _appConfig$future6, _appConfig$future7, _appConfig$future8, _appConfig$future9, _appConfig$future10, _appConfig$future11, _appConfig$future12, _appConfig$future13, _appConfig$future14;
  ...
  if (appConfig.browserBuildDirectory) {
    warnings.warnOnce(browserBuildDirectoryWarning, "browserBuildDirectory");
  }
  ...
  if ((_appConfig$future4 = appConfig.future) !== null && _appConfig$future4 !== void 0 && _appConfig$future4.v2_routeConvention) {
    routesConvention$1 = flatRoutes.flatRoutes;
  } else {
    warnings.warnOnce(flatRoutesWarning, "v2_routeConvention");
  ...
  let future = {
    ...
    unstable_cssSideEffectImports: ((_appConfig$future6 = appConfig.future) === null || _appConfig$future6 === void 0 ? void 0 : _appConfig$future6.unstable_cssSideEffectImports) === true,
    ...
    unstable_vanillaExtract: ((_appConfig$future10 = appConfig.future) === null || _appConfig$future10 === void 0 ? void 0 : _appConfig$future10.unstable_vanillaExtract) ?? false,
    ...
    v2_meta: ((_appConfig$future12 = appConfig.future) === null || _appConfig$future12 === void 0 ? void 0 : _appConfig$future12.v2_meta) === true,
...
const resolveServerBuildPath = (rootDirectory, appConfig) => {
  ...
  if (appConfig.serverBuildDirectory) {
    warnings.warnOnce(serverBuildDirectoryWarning, "serverBuildDirectory");
