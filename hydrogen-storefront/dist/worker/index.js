...
function createMemoryHistory(options) {
  ...
  let index = clampIndex(initialIndex ?? entries.length - 1), action5 = Action.Pop, listener = null;
...
function getUrlBasedHistory(getLocation, createHref, validateLocation, options) {
  ...
  let {
    ...
    v5Compat = !1
  } = options, globalHistory = window2.history, action5 = Action.Pop, listener = null, index = getIndex();
...
function createRouter(init) {
  ...
  async function startRedirectNavigation(state2, redirect7, _temp) {
    ...
    if (invariant(redirectLocation, "Expected a location on the redirect navigation"), ABSOLUTE_URL_REGEX.test(redirect7.location) && isBrowser && typeof ((_window = window) == null ? void 0 : _window.location) < "u") {
      let url = init.history.createURL(redirect7.location), isDifferentBasename = stripBasename(url.pathname, init.basename || "/") == null;
      if (window.location.origin !== url.origin || isDifferentBasename) {
        replace ? window.location.replace(redirect7.location) : window.location.assign(redirect7.location);
        return;
      }
    }
    ...
    !submission && formMethod && formAction && formData && formEncType && (submission = {
      ...
      formEncType,
      formData
    }), redirectPreserveMethodStatusCodes.has(redirect7.status) && submission && isMutationMethod(submission.formMethod) ? await startNavigation(redirectHistoryAction, redirectLocation, {
...
function getFormSubmissionInfo(target, defaultAction, options) {
  let method, action5, encType, formData;
  if (isFormElement(target)) {
    let submissionTrigger = options.submissionTrigger;
    method = options.method || target.getAttribute("method") || defaultMethod, action5 = options.action || target.getAttribute("action") || defaultAction, encType = options.encType || target.getAttribute("enctype") || defaultEncType, formData = new FormData(target), submissionTrigger && submissionTrigger.name && formData.append(submissionTrigger.name, submissionTrigger.value);
  } else if (isButtonElement(target) || isInputElement(target) && (target.type === "submit" || target.type === "image")) {
    let form = target.form;
    if (form == null)
      throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');
    method = options.method || target.getAttribute("formmethod") || form.getAttribute("method") || defaultMethod, action5 = options.action || target.getAttribute("formaction") || form.getAttribute("action") || defaultAction, encType = options.encType || target.getAttribute("formenctype") || form.getAttribute("enctype") || defaultEncType, formData = new FormData(form), target.name && formData.append(target.name, target.value);
  } else {
    if (isHtmlElement(target))
      throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');
    if (method = options.method || defaultMethod, action5 = options.action || defaultAction, encType = options.encType || defaultEncType, target instanceof FormData)
      formData = target;
  ...
  return {
    url: new URL(action5, protocol + "//" + host),
...
function useFormAction(action5, _temp2) {
  let {
    relative
  } = _temp2 === void 0 ? {} : _temp2, {
    basename
  ...
  let [match] = routeContext.matches.slice(-1), path = _extends3({}, useResolvedPath(action5 || ".", {
    relative
  })), location = useLocation();
  if (action5 == null && (path.search = location.search, path.hash = location.hash, match.route.index)) {
    let params = new URLSearchParams(path.search);
    params.delete("index"), path.search = params.toString() ? "?" + params.toString() : "";
  }
  return (!action5 || action5 === ".") && match.route.index && (path.search = path.search ? path.search.replace(/^\?/, "?index&") : "?index"), basename !== "/" && (path.pathname = path.pathname === "/" ? basename : joinPaths([basename, path.pathname])), createPath(path);
}
  ...
  "node_modules/react-router-dom/dist/index.js"() {
    ...
    FormImpl = /* @__PURE__ */ React2.forwardRef((_ref6, forwardedRef) => {
      let {
        ...
        relative,
        preventScrollReset
      } = _ref6, props = _objectWithoutPropertiesLoose(_ref6, _excluded3), submit = useSubmitImpl(fetcherKey, routeId), formMethod = method.toLowerCase() === "get" ? "get" : "post", formAction = useFormAction(action5, {
        relative
      });
...
var require_server = __commonJS({
  "node_modules/react-router-dom/server.js"(exports) {
    ...
    function StaticRouter({
      ...
      let action5 = router.Action.Pop, location = {
...
Incoming: %s`, currentHookNameInDev, "[" + nextDeps.join(", ") + "]", "[" + prevDeps.join(", ") + "]");
      ...
      function basicStateReducer(state, action5) {
        return typeof action5 == "function" ? action5(state) : action5;
      }
      function useState7(initialState) {
        ...
        if (reducer !== basicStateReducer && (currentHookNameInDev = "useReducer"), currentlyRenderingComponent = resolveCurrentlyRenderingComponent(), workInProgressHook = createWorkInProgressHook(), isReRender) {
          ...
          if (renderPhaseUpdates !== null) {
            ...
            if (firstRenderPhaseUpdate !== void 0) {
              ...
              do {
                var action5 = update.action;
                isInHookUserCodeInDev = !0, newState = reducer(newState, action5), isInHookUserCodeInDev = !1, update = update.next;
              } while (update !== null);
      ...
      function dispatchAction(componentIdentity, queue, action5) {
...
function _classExtractFieldDescriptor(receiver, privateMap, action5) {
  if (!privateMap.has(receiver))
    throw new TypeError("attempted to " + action5 + " private field on non-instance");
...
// app/routes/($locale).account.logout.ts
...
// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/errors.js
init_router();

// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/mode.js
var ServerMode;
...
// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/server.js
init_router();

// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/entry.js
function createEntryRouteModules(manifest) {
  return Object.keys(manifest).reduce((memo, routeId) => (memo[routeId] = manifest[routeId].module, memo), {});
}

// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/headers.js
...
// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/invariant.js
...
// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/routeMatching.js
init_router();
...
// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/data.js
...
// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/routes.js
...
// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/markup.js
var ESCAPE_LOOKUP2 = {
  "&": "\\u0026",
  ">": "\\u003e",
  "<": "\\u003c",
...
// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/serverHandoff.js
...
function createRequestHandler2({
  ...
  return async (request) => {
    ...
    return poweredByHeader && response.headers.append("powered-by", "Hydrogen"), response;
  };
}
...
var action = async ({ context }) => doLogout(context);

// app/routes/WorkoutSession._index.tsx
var WorkoutSession_index_exports = {};
__export(WorkoutSession_index_exports, {
  action: () => action2,
  default: () => WorkoutSession,
  loader: () => loader3
});
var import_react5 = __toESM(require_react());

// app/requests/workouts.ts
var workoutRequests = async () => (await fetch("http://localhost:3001/workout", {
  method: "GET",
  headers: { "Content-type": "application/json; charset=UTF-8" }
})).json();

// app/routes/WorkoutSession._index.tsx
var import_jsx_dev_runtime3 = __toESM(require_jsx_dev_runtime()), loader3 = async () => await workoutRequests(), action2 = async () => redirect3("/reps");
function WorkoutSession() {
  let { workouts } = useLoaderData2(), [index, setIndex] = (0, import_react5.useState)(0), [data, setData] = (0, import_react5.useState)([workouts[index]]), navigate = useNavigate(), nextData = () => {
    index !== data.length ? (setData([workouts[index + 1]]), setIndex(index + 1)) : console.log("acabaram os exerc\xEDcios");
  }, backData = () => {
    index > 0 ? (setData([workouts[index - 1]]), setIndex(index - 1)) : console.log("indice menor que zero");
  };
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_jsx_dev_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("header", { className: "bg-purple-800 py-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "container mx-auto flex justify-between items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("h1", { className: "text-white text-2xl font-bold pl-5", children: "Welcome" }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex flex-col items-center", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("section", { className: "flex flex-row", children: data == null ? void 0 : data.map((e) => /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
        "div",
        {
          className: "max-w-xs min-w-min ml-1 mt-1 p-2 border rounded-sm shadow-gray-100",
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("h3", { className: "text-xl font-bold text-gray-900", children: e.workout_name }, void 0, !1, {
              fileName: "app/routes/WorkoutSession._index.tsx",
              lineNumber: 57,
              columnNumber: 17
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("h4", { className: 'text-lg font-bold text-gray-900"', children: e.workout_type }, void 0, !1, {
              fileName: "app/routes/WorkoutSession._index.tsx",
              lineNumber: 60,
              columnNumber: 17
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("p", { className: "text-sm text-gray-600", children: e.how_to_perform }, void 0, !1, {
              fileName: "app/routes/WorkoutSession._index.tsx",
              lineNumber: 63,
              columnNumber: 17
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex items-center justify-center", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("button", { className: "text-white bg-purple-800 font-medium rounded-lg text-sm px-5 py-3.5 mt-2 text-center", children: "Finish workout" }, void 0, !1, {
        fileName: "app/routes/WorkoutSession._index.tsx",
        lineNumber: 91,
        columnNumber: 9
      }, this)
...
var RestTimer_index_exports = {};
__export(RestTimer_index_exports, {
  default: () => RestTimer
});
var import_react6 = __toESM(require_react());
var import_jsx_dev_runtime4 = __toESM(require_jsx_dev_runtime());
function RestTimer() {
  let [seconds, setSeconds] = (0, import_react6.useState)(90), navigate = useNavigate();
  return (0, import_react6.useEffect)(() => {
    let interval = setInterval(() => {
      setSeconds((prevSeconds) => prevSeconds - 1);
    }, 1e3);
    return seconds === 0 && clearInterval(interval), () => {
      clearInterval(interval);
    };
  }, [seconds]), /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(import_jsx_dev_runtime4.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("header", { className: "bg-purple-800 py-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "container mx-auto flex justify-between items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("h1", { className: "text-white text-2xl font-bold pl-5", children: "Welcome" }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex flex-col items-center justify-items-center", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "w-64 p-2 border rounded-sm shadow-gray-100 flex items-center justify-center px-6 py-8 mx-auto mt-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("h1", { className: "text-4xl text-purple-900", children: ((seconds2) => {
        let minutes = Math.floor(seconds2 / 60), remainingSeconds = seconds2 % 60, formattedMinutes = String(minutes).padStart(2, "0"), formattedSeconds = String(remainingSeconds).padStart(2, "0");
...
// app/routes/Workouts._index.tsx
var Workouts_index_exports = {};
__export(Workouts_index_exports, {
  default: () => WorkoutIndexPage
});
var import_jsx_dev_runtime5 = __toESM(require_jsx_dev_runtime());
function WorkoutIndexPage() {
  let navigate = useNavigate();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(import_jsx_dev_runtime5.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("header", { className: "bg-purple-800 py-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "container mx-auto flex justify-between items-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("h1", { className: "text-white text-2xl font-bold pl-5", children: "Welcome" }, void 0, !1, {
      fileName: "app/routes/Workouts._index.tsx",
      lineNumber: 10,
      columnNumber: 11
    }, this) }, void 0, !1, {
      fileName: "app/routes/Workouts._index.tsx",
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex justify-center items-center h-screen", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "w-80 h-96 bg-white rounded-lg border-2 border-gray-300 flex flex-col items-center justify-center space-y-9", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("h2", { className: "text-gray-900 font-bold text-xl", children: "Ready?" }, void 0, !1, {
        fileName: "app/routes/Workouts._index.tsx",
        lineNumber: 15,
        columnNumber: 11
      }, this),
...
var SignUp_index_exports = {};
__export(SignUp_index_exports, {
  action: () => action3,
  default: () => SignUp
});

// app/requests/user.ts
var createUserRequest = async (username, password) => (await fetch("http://localhost:3001/user/create", {
  method: "POST",
...
// app/routes/SignUp._index.tsx
var import_jsx_dev_runtime6 = __toESM(require_jsx_dev_runtime()), action3 = async ({ request }) => {
  let form = await request.formData(), username = form.get("username"), password = form.get("password");
  return (await createUserRequest(username, password)).token ? redirect3("/workouts") : redirect3("/signUp");
};
function SignUp() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { className: "flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("h1", { className: "flex items-center mb-6 text-2xl font-semibold text-gray-900 ", children: "Workout Tracker" }, void 0, !1, {
      fileName: "app/routes/SignUp._index.tsx",
      lineNumber: 21,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { className: "w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { className: "p-6 space-y-4 md:space-y-6 sm:p-8", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("h2", { className: "text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl", children: "Create an account" }, void 0, !1, {
        fileName: "app/routes/SignUp._index.tsx",
        lineNumber: 27,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("form", { method: "post", className: "space-y-4 md:space-y-6", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("p", { className: "text-sm font-light text-gray-500 ", children: [
...
var Login_index_exports = {};
__export(Login_index_exports, {
  action: () => action4,
  default: () => LoginIndexPage
});

// app/requests/login.ts
var loginRequest = async (username, password) => (await fetch("http://localhost:3001/login", {
  body: JSON.stringify({ username, password }),
  method: "POST",
  headers: { "Content-type": "application/json; charset=UTF-8" }
})).json();
...
// app/routes/Login._index.tsx
var import_jsx_dev_runtime7 = __toESM(require_jsx_dev_runtime()), action4 = async ({ request }) => {
  let form = await request.formData(), username = form.get("username"), password = form.get("password");
  return (await loginRequest(username, password)).token ? redirect3("/workouts") : redirect3("/login");
};
function LoginIndexPage() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("h1", { className: "flex items-center mb-6 text-2xl font-semibold text-gray-900", children: "Workout Tracker" }, void 0, !1, {
      fileName: "app/routes/Login._index.tsx",
      lineNumber: 25,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "p-6 space-y-4 md:space-y-6 sm:p-8", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("h2", { className: "text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl", children: "Sign in to your account" }, void 0, !1, {
        fileName: "app/routes/Login._index.tsx",
        lineNumber: 31,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(
        "form",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("p", { className: "text-sm font-light text-gray-500 ", children: [
...
function Index() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(LoginIndexPage, {}, void 0, !1, {
...
function LoginRoute() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("main", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(Outlet, {}, void 0, !1, {
...
var redirect4 = function(url, init) {
  init === void 0 && (init = 302);
  let responseInit = init;
  typeof responseInit == "number" ? responseInit = {
    status: responseInit
  ...
  let headers = new Headers(responseInit.headers);
  return headers.set("Location", url), new Response(null, _extends5({}, responseInit, {
    headers
  }));
};
var validMutationMethodsArr2 = ["post", "put", "patch", "delete"], validMutationMethods2 = new Set(validMutationMethodsArr2), validRequestMethodsArr2 = ["get", ...validMutationMethodsArr2], validRequestMethods2 = new Set(validRequestMethodsArr2);
var UNSAFE_DEFERRED_SYMBOL2 = Symbol("deferred");

// node_modules/@remix-run/server-runtime/dist/esm/responses.js
var redirect6 = (url, init = 302) => redirect4(url, init);
...
}, LIB_VERSION = "2023.4.3", StorefrontApiError = class extends Error {
...
var SeoLogger = (0, import_react10.lazy)(() => Promise.resolve().then(() => (init_log_seo_tags_URUAZSXD(), log_seo_tags_URUAZSXD_exports)));

// node_modules/@shopify/cli-hydrogen/dist/virtual-routes/routes/graphiql.jsx
var loader4 = graphiqlLoader;
...
function Layout(props) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("div", { className: "hydrogen-virtual-route", children: props.children }, void 0, !1, {
...
// node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx
var import_jsx_dev_runtime11 = __toESM(require_jsx_dev_runtime(), 1), links2 = () => [
...
function App2() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("html", { lang: "en", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("head", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("title", { children: "Hydrogen" }, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 22,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("meta", { name: "description", content: "A custom storefront powered by Hydrogen" }, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 23,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(Meta, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 24,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(Links, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 25,
        columnNumber: 7
      }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("body", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(Layout, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(Outlet, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 28,
        columnNumber: 15
      }, this) }, void 0, !1, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(ScrollRestoration2, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 29,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(Scripts, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 30,
        columnNumber: 7
      }, this)
...
var assets_manifest_default = { version: "e1c95700", entry: { module: "/build/entry.client-7GHB4F7Q.js", imports: ["/build/_shared/chunk-NXWCPLMB.js", "/build/_shared/chunk-AQO2IFES.js", "/build/_shared/chunk-5KL4PAQL.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-45ZQ42UK.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/($locale).account.logout": { id: "routes/($locale).account.logout", parentId: "root", path: ":locale?/account/logout", index: void 0, caseSensitive: void 0, module: "/build/routes/($locale).account.logout-KDSNWFEL.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/Login": { id: "routes/Login", parentId: "root", path: "Login", index: void 0, caseSensitive: void 0, module: "/build/routes/Login-J3SQPENR.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/Login._index": { id: "routes/Login._index", parentId: "routes/Login", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/Login._index-MLCMTOGF.js", imports: ["/build/_shared/chunk-MIDXC3YN.js"], hasAction: !0, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/RestTimer._index": { id: "routes/RestTimer._index", parentId: "root", path: "RestTimer", index: !0, caseSensitive: void 0, module: "/build/routes/RestTimer._index-UXO7GUTV.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/SignUp._index": { id: "routes/SignUp._index", parentId: "root", path: "SignUp", index: !0, caseSensitive: void 0, module: "/build/routes/SignUp._index-7YLU4WY6.js", imports: void 0, hasAction: !0, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/WorkoutSession._index": { id: "routes/WorkoutSession._index", parentId: "root", path: "WorkoutSession", index: !0, caseSensitive: void 0, module: "/build/routes/WorkoutSession._index-JGQIC3O7.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/Workouts._index": { id: "routes/Workouts._index", parentId: "root", path: "Workouts", index: !0, caseSensitive: void 0, module: "/build/routes/Workouts._index-7ZVUCQX2.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-4P4NB4RP.js", imports: ["/build/_shared/chunk-MIDXC3YN.js"], hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "virtual-routes/routes/graphiql": { id: "virtual-routes/routes/graphiql", parentId: "virtual-routes/virtual-root", path: "graphiql", index: void 0, caseSensitive: void 0, module: "/build/virtual-routes/routes/graphiql-GPDYRMZP.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "virtual-routes/virtual-root": { id: "virtual-routes/virtual-root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/virtual-routes/virtual-root-KW3BFBEL.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, cssBundleHref: void 0, hmr: void 0, url: "/build/manifest-E1C95700.js" };
...
var assetsBuildDirectory = "dist/client/build", future = { unstable_cssModules: !1, unstable_cssSideEffectImports: !1, unstable_dev: !1, unstable_postcss: !1, unstable_tailwind: !1, unstable_vanillaExtract: !1, v2_errorBoundary: !0, v2_meta: !0, v2_normalizeFormMethod: !0, v2_routeConvention: !0 }, publicPath = "/build/", entry = { module: entry_server_exports }, routes = {
  ...
  "routes/WorkoutSession._index": {
    id: "routes/WorkoutSession._index",
    parentId: "root",
    path: "WorkoutSession",
    index: !0,
    caseSensitive: void 0,
    module: WorkoutSession_index_exports
  },
  "routes/RestTimer._index": {
    id: "routes/RestTimer._index",
    parentId: "root",
    path: "RestTimer",
    index: !0,
    caseSensitive: void 0,
    module: RestTimer_index_exports
  },
  "routes/Workouts._index": {
    id: "routes/Workouts._index",
    parentId: "root",
    path: "Workouts",
    index: !0,
    caseSensitive: void 0,
    module: Workouts_index_exports
  },
  "routes/SignUp._index": {
    id: "routes/SignUp._index",
    parentId: "root",
    path: "SignUp",
    index: !0,
    caseSensitive: void 0,
    module: SignUp_index_exports
  },
  "routes/Login._index": {
